...
POSTGRES_DB="${POSTGRES_DB:-puddingclaw}"
POSTGRES_USER="${POSTGRES_USER:-puddingclaw}"
POSTGRES_PASSWORD="${POSTGRES_PASSWORD:-puddingclaw}"
POSTGRES_SERVICE_URL="postgresql://127.0.0.1:${POSTGRES_PORT}"
HIGRESS_GATEWAY_URL="http://localhost:8080"
HIGRESS_CONSOLE_URL="http://localhost:8001"
MILVUS_SERVICE_URL="grpc://localhost:19530"
MINERU_API_URL="http://localhost:8002"
...
echo ""
echo -e "${YELLOW}[提示] 如需使用 PostgreSQL / Higress / Milvus / MinerU，请确保对应服务已启动${NC}"
echo -e "       docker ps | grep -E 'postgres|higress|milvus|mineru'"
echo ""
echo "============================================"
