...
from .models import LegacyDatabaseSqlValidateInput
from .scope import resolve_database_source_scope
from .spans import emit_database_span


class LegacyDatabaseSqlValidateTool(BaseTool):
    name: str = "database_sql_validate_legacy"
    description: str = (
    ...
    args_schema: type[BaseModel] = LegacyDatabaseSqlValidateInput
    risk_level: str = "safe"
    session_id: str = ""
